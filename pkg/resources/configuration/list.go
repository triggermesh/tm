...
func (c *Configuration) List(clientset *client.ConfigSet) (*servingv1.ConfigurationList, error) {
	return clientset.Serving.ServingV1().Configurations(c.Namespace).List(metav1.ListOptions{})
}
