...
func (b *Buildtemplate) List(clientset *client.ConfigSet) (string, error) {
	_, err := clientset.Build.BuildV1alpha1().BuildTemplates(b.Namespace).List(metav1.ListOptions{})
	if err != nil {
